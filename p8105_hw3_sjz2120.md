...
```
    ...
    ##    <chr>       <date>     <dbl> <ord>    <int> <dbl> <dbl> <dbl> <dbl> <dbl>
    ##  1 US1NYAB0001 2007-11-01  2007 November     1    NA    NA    NA    NA    NA
    ##  2 US1NYAB0001 2007-11-02  2007 November     2    NA    NA    NA    NA    NA
    ##  3 US1NYAB0001 2007-11-03  2007 November     3    NA    NA    NA    NA    NA
    ##  4 US1NYAB0001 2007-11-04  2007 November     4    NA    NA    NA    NA    NA
    ##  5 US1NYAB0001 2007-11-05  2007 November     5    NA    NA    NA    NA    NA
    ##  6 US1NYAB0001 2007-11-06  2007 November     6    NA    NA    NA    NA    NA
    ##  7 US1NYAB0001 2007-11-07  2007 November     7    NA    NA    NA    NA    NA
    ##  8 US1NYAB0001 2007-11-08  2007 November     8    NA    NA    NA    NA    NA
    ##  9 US1NYAB0001 2007-11-09  2007 November     9    NA    NA    NA    NA    NA
    ## 10 US1NYAB0001 2007-11-10  2007 November    10    NA    NA    NA    NA    NA
    ## # … with 2,595,166 more rows
...
**For snowfall, the most commonly observed values seem to be 0, probably
because there are many weather station locations where it doesn’t snow
at all (basically, anywhere where the climate is mild/warm year-round or
doesn’t support snowfall).**
...
temperatures in January hovering around 15-20 degrees Celcius lower than
temperatures in July for all years. Most of the January average max
temperatures fall below 10 degrees Celcius; while most of the July
average max temperatures fall above 20 degrees Celcius. There are some
outliers in both the January and July data in a few years which hover
between 10-20 degrees Celcius. It’s difficult to tell any overall trends
in average max temperature across the years from these plots, if only
because there is still quite a bit of variation within each year and
between years.
