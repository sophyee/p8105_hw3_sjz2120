...
### Table aggregating total daily activity per each day (`accel_data`)
...
daily_activity_plot =
  ggplot(accel_pivot_data, aes(x = hour, y = activity_level, group = interaction(day_id, day), color = day)) +
