...
The dataset accel_data contains a total of `r nrow(accel_data)` rows and `r ncol(accel_data)` columns, with each row representing a single product from an instacart order.
