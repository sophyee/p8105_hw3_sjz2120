...
noaa %>% 
  ...
  summarise(snow = snow) %>% # Create new variable for average max temperatures, grouped by station id, year, and month
  ggplot(aes(x = snow, fill = year)) + # Create a scatterplot of average max temperatures in each station across the years
